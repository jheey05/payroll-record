...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <title>Non-Teaching Employee</title>
        <link rel="stylesheet" href="teachingpayrollstyle.css">
    </head>
    <body>

    <?php require_once 'nonteachingpayrollprocess.php'; ?>

    <nav>
            <label class="logo">ABCS Institute</label>
            <ul>
                <li><a href="nonteachingemployee_record.php">Employee Record</a></li>
                <li><a class="active" href="nonteachingemployee_payroll.php">Employee Payroll</a></li>
    ...
    <?php
        ...
        if(isset($_POST["calculate"])){
            ...
            if($_POST["ovrtmhrs"] <= 48 ){


                    $ovrhrs = $_POST["ovrtmhrs"];
                }
            else{
        ...
        if(isset($_POST["total"])){
            ...
            if($allwnc == "Yes"){
                ...
                //allowance
                $totalallwnc =  $monthlypay * 0.10;

                //absences
                $totaldeduct = $_POST["deduct"] * ($monthlypay / 30 / 8);

                //overtime
                $overrate = ($monthlypay / 30 / 8) * 1.4;
                $totalovertm = $overhrs1 * $overrate;

                //total amount
                $pay = ($monthlypay + $totalovertm + $totalallwnc) - $totaldeduct;
                ...
                //total amount
                $pay = ($monthlypay + $totalovertm) - $totaldeduct;
    ...
    ?>
        ...
        $conn = mysqli_connect('localhost', 'jhey.vill', 'akosijellyann05', 'non_teaching_record');
        //pre_r($result);
        ?>

        <div class="container">
            <table class="table">
                <h2> Non-Teaching Employee Record for PAYROLL</h2>
                <thead>
                    <tr>
                        <th>Employee ID</th>
                        <th>Salary</th>
            ...
            <?php
                ...
                <tr>
                    ...
                    <td>
                        <a href="nonteachingemployee_payroll.php?edit=<?php echo $row['payroll_id']; ?>"
                            ><button type="button" class="button-info">Edit</button></a>
                        <a href="nonteachingpayrollprocess.php?delete=<?php echo $row['payroll_id']; ?>"
        ...
        <fieldset><legend>Calculation of Non-Teaching Hours</legend>
        ...
        <label for="field1"><span>Employee ID <span class="required">*</span></span>
                <select name="emp_id101" class="input-field">
                    <?php
                        ...
                        $databaseName = "non_teaching_record";
            ...
            <label for="field2"><span>Teaching Hours </span>
                ...
                <input type ="type2" name ="reghrs" class ="input-field" placeholder ="in a month">
                <input type ="type1" name ="ovrtmhrs" class ="input-field" placeholder ="in a month">

                <p> Note: Regular Hours (max. 240 hrs in a month) </p>
                <p> Note: Overtime Hours (max. 48 hrs in a month) </p>
        ...
        <div class="form-style-2">
            ...
            <label for="field14"><span> Employee ID </span>
                <input type ="type" name ="employee_id1" class ="input-field" placeholder ="(calculate the non-teaching hrs)"
            ...
            <label for="field3"><span> Overall Hours </span>
                <input type ="type" name ="tchhrs" class ="input-field" placeholder ="(calculate the teaching hrs)"
                value="<?php echo $tchhrs; ?>" readonly>
            <label for="field4"><span> Monthly Payrate</span>
                <input type ="type" name ="payrate" class ="input-field" value="₱16,000" readonly>
        ...
        <div class="form-style-1">
            <form action="nonteachingpayrollprocess.php" method="POST">

            <fieldset><legend>Non-Teaching Employee Payroll</legend>
