...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="nonteachingrecordstyle.css">
    ...
    <nav>
            ...
            <ul>
                <li><a class="active" href="nonteachingemployee_record.php">Employee Record</a></li>
                <li><a  href="nonteachingemployee_payroll.php">Employee Payroll</a></li>
        ...
        <div class="container">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td>
                        <a href="nonteachingemployee_record.php?edit=<?php echo $row['employee_id']; ?>"
                            ><button type="button" class="button-info">Edit</button></a>
                        <a href="process2.php?delete=<?php echo $row['employee_id']; ?>"
        ...
        <div class="form-style-3">
            ...
            <fieldset><legend>Non-Teaching Employee Record</legend>
